...
```text
# 服务端进程抛出的异常
2023-04-14 15:43:36.159 8043-8061/net.bi4vmr.study E/JavaBinder: *** Uncaught remote exception!  (Exceptions are not yet supported across processes.)
...
# 客户端进程读取到了默认值
2023-04-14 15:43:36.160 7998-7998/net.bi4vmr.study I/myapp-client: PID: 0
```
...
```text
2023-04-14 16:07:11.324 8173-8173/net.bi4vmr.study E/AndroidRuntime: FATAL EXCEPTION: main
