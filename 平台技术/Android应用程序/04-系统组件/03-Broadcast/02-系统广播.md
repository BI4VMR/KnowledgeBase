...
```text
2022-03-24 17:34:00.524 27108-27108/net.bi4vmr.study I/myapp: 已注册TimeTickReceiver
2022-03-24 17:35:00.004 27108-27108/net.bi4vmr.study I/myapp: Time Tick.
2022-03-24 17:36:00.005 27108-27108/net.bi4vmr.study I/myapp: Time Tick.
2022-03-24 17:37:00.002 27108-27108/net.bi4vmr.study I/myapp: Time Tick.
2022-03-24 17:38:00.005 27108-27108/net.bi4vmr.study I/myapp: Time Tick.
```
...
配置完成后，将示例程序装入设备并重启设备，当设备启动完毕后，无需打开该程序，控制台也能输出"系统启动完成"消息，此处的日志输出可以替换为实际需要执行的自启任务，实现程序开机自启。
