...
|       序号        |                                摘要                                |
| :---------------: | :----------------------------------------------------------------: |
| [案例一](#案例一) | 模块构建时出现错误： `does not export <类名> to unnamed module` 。 |

</div>

## 案例一
### 问题描述
模块构建时出现错误： `does not export <类名> to unnamed module` :
...
/home/bi4vmr/.gradle/daemon
/home/bi4vmr/.gradle/caches
