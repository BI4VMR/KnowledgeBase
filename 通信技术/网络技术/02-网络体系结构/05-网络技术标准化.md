...
![OSI/RM结构](./Assets-网络技术标准化/开放系统互联参考模型-OSIRM结构.jpg)
...
![TCP/IP结构](./Assets-网络技术标准化/TCPIP参考模型-TCPIP结构.jpg)
...
![五层模型结构](./Assets-网络技术标准化/五层参考模型-五层模型结构.jpg)
...
一个提案在被正式接受并作为RFC发布之前，将作为临时的Internet草案存在，在编辑与审查过程中将接收意见并公布进展。
