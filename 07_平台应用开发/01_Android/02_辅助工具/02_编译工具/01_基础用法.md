...
该配置文件中的 `pluginManagement{}` 与 `dependencyResolutionManagement{}` 小节用于配置Gradle插件与依赖组件仓库信息，详见相关章节： [🧭 Gradle - 仓库管理](../../../../编程工具/Gradle/02_基础用法.md#仓库管理) 。

该配置文件中的剩余部分用于配置项目结构，声明各个子模块，详见相关章节： [🧭 Gradle - 模块管理](../../../../编程工具/Gradle/02_基础用法.md#模块管理) 。
...
该配置文件中的 `dependencies{}` 小节用于声明当前模块所依赖的外部组件，详见相关章节： [🧭 Gradle - 依赖管理](../../../../编程工具/Gradle/03-依赖管理.md) 。
...
![BuildTypes的基本应用](./Assets-基础用法/BuildTypes-BuildTypes的基本应用.jpg)
