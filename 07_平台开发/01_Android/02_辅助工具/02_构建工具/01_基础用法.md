...
AGP的版本需要与Gradle版本相匹配，相关信息可在Android Developer网站的 [🔗 AGP版本说明](https://developer.android.com/build/releases/about-agp?hl=zh-cn#updating-gradle) 页面中查询；具体组件版本可参考 [🔗 Google Maven - AGP](https://maven.google.com/web/index.html?#com.android.application:com.android.application.gradle.plugin) 页面。
