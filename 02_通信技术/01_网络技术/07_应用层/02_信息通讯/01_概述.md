...
# 理论基础
## MIME
多用途互联网邮件扩展(Multipurpose Internet Mail Extensions, MIME)也被称为“IANA媒体类型”，用于描述电子邮件中各部分内容的格式。相关标准在RFC 2045、RFC 2046、RFC 2047、RFC 2048、RFC 2049等文档定义与演进。
...
MIME与常见文件格式的对应关系可参考以下页面：

[🧭 MIME与常见文件格式的对应关系 ](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types)
